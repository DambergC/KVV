...
#########################################################
$xmlPath = Join-Path -Path $PSScriptRoot -ChildPath 'Send-CheckDPStatusV2.XML'
...
zSji7zpenNgf/tgSGIN1aQfmCXIG5AbhZED5ez8Niphl3rvnzgA0kneSsAlaQNMCcCXzoOva7wIGp/24MwQpDXQGeWyf8pkvzGdQEcTJwZp7qXWmE/wettNO/1iYB3AAAAABJRU5ErkJggg=="'
    ...
    New-HTMLSection -HeaderText $reportTitle -HeaderTextSize 20 -HeaderBackGroundColor Darkblue {
        New-HTMLTag -Tag 'div' -Attributes @{ class = 'summary' } {
            ...
            New-HTMLTag -Tag 'div' { "Antal DPs som svarar p� ping: <b>$SucceededDPscount</b>" }
            New-HTMLTag -Tag 'div' { "Antal DPs som inte svarar p� ping: <b>$FailedDpscount</b>" }
        }
    }

    New-HTMLSection -HeaderText "Offline DPs - �tg�rdade ($($offlineRows.Count))" -HeaderTextSize 20 -HeaderBackGroundColor Darkblue {
    ...
    New-HTMLSection -HeaderText "Online DPs - �terst�llda ($($restoreRows.Count))"  -HeaderTextSize 20 -HeaderBackGroundColor Darkblue{
    ...
    <##
    New-HTMLSection -HeaderText "Ingen �ndring ($($noChangeRows.Count))" -HeaderTextSize 20 -HeaderBackGroundColor Darkblue {
    ...
    ##>
    New-HTMLSection -HeaderText "Fel ($($errorRows.Count))" -HeaderTextSize 20 -HeaderBackGroundColor Darkblue {
