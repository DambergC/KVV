...
[System.Xml.XmlDocument]$xml = Get-Content .\ScriptConfigPatchReleased.xml
...
$UpdatesFound = $result | Sort-Object dateposted -Descending | ConvertTo-Html -Title "Downloaded patches" -PreContent $pre -PostContent $post -Head $header
